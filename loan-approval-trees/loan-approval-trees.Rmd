---
title: "Loan Approval Using Tree-based Methods"
...
```{r}
loan_raw <- read.csv('https://raw.githubusercontent.com/maelillien/cuny-projects/main/loan-approval-trees/Loan_approval.csv', header = TRUE)
